          ...
          <main className="p-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      return (
                        <div key={index} className="flex flex-col items-center flex-1">
                          <div
                            ...
                            style={{ height: `${height}%` }}
                          ></div>
                          <span className="text-xs text-gray-600 mt-2">{salesData.labels[index]}</span>
                        </div>
                      );
                    })}
                  </div>
              ...
              <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-100">
                ...
                <button className="w-full mt-6 text-indigo-600 hover:text-indigo-800 text-sm font-medium">
